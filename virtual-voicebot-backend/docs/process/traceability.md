...
| RD-004 | 電話番号振り分け・迷惑電話対策 | BD-004 | - | 設計済み（STEER-110 で DB 設計完了） |
...
| RD-004 | 電話番号振り分け・迷惑電話対策 | ST-003（予定） | 未定義 | ST 仕様作成要 |
...
| BD-003 | クリーンアーキテクチャ | - | 未定義 | IT仕様作成要 |
| BD-004 | 着信ルーティング DB | - | 未定義 | IT仕様作成要 |
...
> RD-004 の ST-003 が未定義（テスト定義済み 75%）
...
| BD-003 | クリーンアーキテクチャ | IT仕様未作成 | 要作成 |
| BD-004 | 着信ルーティング DB | IT仕様未作成 | 要作成 |
...
| 2026-02-07 | 1.2 | RD-004 → BD-004 マッピング追加、BD-003/004 を IT Gap に追加、カバレッジ更新 | Claude Code |
