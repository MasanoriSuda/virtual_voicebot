<!-- SOURCE_OF_TRUTH: Backend 品質ゲート定義 -->
# 品質ゲート定義（QG）
...
| 7 | RDファイルが1関心事に収まっている（SOURCE_OF_TRUTH ヘッダーあり） | Arch |
...
| 7 | BDファイルが1関心事に収まっている（SOURCE_OF_TRUTH ヘッダーあり） | Arch |
...
| 8 | DDファイルが1関心事に収まっている（SOURCE_OF_TRUTH ヘッダーあり） | Arch |
...
| # | チェック項目 |
|---|-------------|
| 1 | ドキュメントは1関心事に収まっているか（行数制限ではなく構造の凝集性を重視） |
...
| 2026-02-07 | 1.1 | 「100行以下」ルールを「1関心事 + SOURCE_OF_TRUTH ヘッダー」に変更（Codex 指摘対応） | Claude Code |
