...
mod tests {
    ...
    fn intro_path_matches_time_window() {
        assert_eq!(
            ...
            crate::protocol::session::coordinator::INTRO_MORNING_WAV_PATH
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            crate::protocol::session::coordinator::INTRO_AFTERNOON_WAV_PATH
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            crate::protocol::session::coordinator::INTRO_EVENING_WAV_PATH
        );
        assert_eq!(
