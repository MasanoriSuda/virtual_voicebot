...
### ドキュメント整備（2025-12-28 追加）
- [x] Backend CLAUDE.md 作成・整形（Source of Truth ヘッダ追加）✅
- [x] DOCS_INDEX.md に CLAUDE.md（root/backend）追加 ✅
- [x] DOCS_POLICY.md 階層図に backend CLAUDE.md 追加 ✅
- [x] DOCS_POLICY.md §3.3 正本一覧に CLAUDE.md 追加 ✅
...
| /virtual-voicebot-backend/CLAUDE.md | Backend開発ガイド（2025-12-28 新規作成）|
| /AGENTS.md | ルート版（24行）|
