...
| **Phase 6** | **#144** | **本ステアリング** | **Draft** | **Frontend-Backend E2E 統合** |
...
- [ ] AC-5: Frontend UI で IVR（IV）を設定した後、着信時に IVR フローが実行される
