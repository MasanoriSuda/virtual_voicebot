<!-- SOURCE_OF_TRUTH: 電話番号振り分け・迷惑電話対策要件 -->
...
| NFR-103 | 履歴保存期間 | 録音 90 日 / 履歴 365 日 | STEER-110 D-12 で決定 |
...
- [x] Q3: 録音データの保存期間とストレージ容量の見積もりは？ → **録音 90 日、履歴 365 日（STEER-110 D-12 で決定）**
...
| 2026-02-07 | 0.9 | Q3 クローズ（録音 90 日 / 履歴 365 日、STEER-110 D-12）、NFR-103 更新 | Claude Code |
